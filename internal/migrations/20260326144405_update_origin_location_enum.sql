...
ALTER TABLE users ALTER COLUMN origin_location TYPE VARCHAR(255) USING origin_location::text;
...
ALTER TABLE users ALTER COLUMN origin_location TYPE origin_location_enum USING origin_location::origin_location_enum;
-- +goose StatementEnd
